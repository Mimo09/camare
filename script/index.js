	...
	var LearnMoreButton  = document.getElementById("home-learn-more-button");
	var LeanMoreModal = document.getElementById('home-learn-more-modal');
	var LearnMoreClose = document.getElementsByClassName("home-learn-more-close")[0];	 
	...
	var icon1Button  = document.getElementById("home-icon-1");
	var icon1Modal = document.getElementById('home-content-3-modal-1');
	var icon1Close = document.getElementsByClassName("home-content-3-close-1")[0];	 
	...
	var icon2Button  = document.getElementById("home-icon-2");
	var icon2Modal = document.getElementById('home-content-3-modal-2');
	var icon2Close = document.getElementsByClassName("home-content-3-close-2")[0];	 
	...
	var icon3Button  = document.getElementById("home-icon-3");
	var icon3Modal = document.getElementById('home-content-3-modal-3');
	var icon3Close = document.getElementsByClassName("home-content-3-close-3")[0];	 
